...
PRODUCT_PACKAGES += \
    ...
    libvolumelistener \
    audio_parameter_service.samsung_sm7225
...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/configs/audio/audio_platform_info_lagoon_qrd.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_intcodec.xml \
    $(COMMON_PATH)/configs/audio/audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration.xml \
    $(COMMON_PATH)/configs/audio/mixer_paths_lagoonqrd.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_lagoonqrd.xml \
...
PRODUCT_COPY_FILES += \
    $(COMMON_PATH)/system.prop:$(TARGET_COPY_OUT_SYSTEM)/build.prop \
    $(COMMON_PATH)/vendor.prop:$(TARGET_COPY_OUT_VENDOR)/build.prop \
    $(COMMON_PATH)/odm.prop:$(TARGET_COPY_OUT_ODM)/etc/build.prop
